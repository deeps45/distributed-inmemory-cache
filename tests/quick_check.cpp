...
int main() {
  cache::ShardedCache<std::string, std::string> c(/*capacity=*/3, /*shards=*/1, /*use_pool=*/true,
                                                    /*use_read_buffer=*/true, std::chrono::milliseconds(0));
  ...
  // TTL
  cache::ShardedCache<std::string, std::string> ttl_cache(10, 1, true, false, std::chrono::milliseconds(0));
  ...
  cache::ShardedCache<int, int> conc(1000, 8, true, false, std::chrono::milliseconds(50));
